...
In this work, I combine yelp data through Yelp API with food inspection data from City of Chicago data portal to understand the correlation between yelp review score and city food inspection. Two interesting study areas are Chinatown and Downtown.
